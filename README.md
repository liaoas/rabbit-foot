...
rabbit-foot 是一个使用 Json 来描述爬虫的动作，从而实现动态的爬虫。相较于通过硬编码来实现爬虫，这种方式更加灵活，只需要修改描述爬虫行为的Json就可以应对目标服务的改变，而无需从新编码
  ...
  "books": [
    {
      "name": "新笔趣阁",
      "spider-type": "search",
      "type": "com.rabbit.foot.core.resolver.html.WebResolver",
      "site": {
        "method": "GET",
